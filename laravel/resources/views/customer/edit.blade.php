            ...
            <div class="col-lg-6 mg-b-20">
                <div class="br-section-wrapper" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <hr>
                        <form method="POST" action="{{ route($base_route.'.update', $customer->id) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group ">
                                ...
                                <br>
                                <img height="100" class="mg-b-10" src="{{url('backend/images/customers/'.$customer->logo)}}" alt="">
                                <br>
