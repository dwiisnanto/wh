                    ...
                    <div class="card shadow-base  bd-0  card__one mg-b-20 rounded-20" style="">
                        <div class="card-header  bg-teal d-flex justify-content-between align-items-center"
                            ...
                            <h6 class="card-title text-white tx-uppercase tx-12 mg-b-0">
                                <i class="icon ion-home"></i> {{$purchase_requisition->project->name}}</h6>
                            <span
                ...
                <div class="br-section-wrapper  rounded-20" style="padding: 30px 20px">
                    ...
                    <div style="align" class="row">
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <a href="{{url($base_route.'/summary') }}" class="">
                            ...
                            <button class="btn btn-sm btn-success float-right" data-toggle="modal"
                                data-target="#modaldemo1"><i class="icon ion ion-checkmark"></i> Verified</button>
                            @endif
                                ...
                                <table class="table  display  responsive" id="datatable1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <button class="btn btn-sm btn-danger" onclick="deleteItem({{$po_item->id}})"
    ...
    <div id="modaldemo1" class="modal fade">
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content bd-0 tx-14">
                ...
                <form action="{{url($base_route.'/purchase-orders/'.$purchase_order->id.'/verified')}}" method="post">
                    @csrf
                    ...
                    <div class="modal-body pd-25">
                        ...
                        <small>*Verify if all items have arrived, and the status will change to warehouse </small>
                    </div>
                    <div class=" modal-footer">
                        <button class="btn btn-success tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium"
                            type="submit">verified</button>
                        <button type="button"
            ...
            <div class="modal-content bd-0 tx-14">
                ...
                <form action="{{url($base_route.'/update-item')}}" method="post">
                    ...
                    <div class="modal-body pd-25">
                        ...
                        <div class="form-group">
                            <label for="">Qty :</label>
                            <input type="number" min="0" max=" " name="qty_po" id="edit_qty" class="form-control "
                                required>
                        </div>

                        <div class="form-group">
                            <label for="">Price :</label>
                            <input type="number" min="0" name="price_po" class="form-control" id="edit_price" value=""
                                required>
                        </div>

                        <div class="form-group">
                            <label for="">Disc :</label>
                            <input type="number" min="0" max=" " name="disc_po" class="form-control" id="edit_disc"
                                required>
                        </div>

                        <div class="form-group">
                            <label for="">Net Price :</label>
                            <input type="number" min="0" max=" " name="net_price" class="form-control"
                                id="edit_net_price" required>
                        </div>
