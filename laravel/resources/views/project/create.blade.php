            ...
            <div class="col-lg-6 mg-b-20">
                <div class="br-section-wrapper" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <hr>
                        <form method="POST" action="{{ route($base_route.'.store') }}" enctype="multipart/form-data">
                            @csrf
                            @if ($errors->any())
                            ...
                            name="project_number" value="{{$project_number}}" readonly>
                            ...
                            <div class="form-group ">
                                ...
                                <textarea class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}"
                                    name="description" id="" cols="30" rows="3">{{old('name')}}</textarea>
