            ...
            <div class="col-lg-6 mg-b-20">
                <div class="br-section-wrapper" style="padding: 30px 20px">
                    <div style="align">
                        ...
                        <hr>
                        {{-- <form method="POST" action="{{ route($base_route.'.update', $item->id) }}"> --}}
                        <form method="POST" action="{{ url($base_route.'/'. $item->id.'/update') }}">
                            @csrf
                            ...
                            <div class="form-group ">
                                ...
                                <textarea class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}"
                                    name="description" id="" cols="30" rows="3">{{ $item->description }}</textarea>
                            ...
                            <div class="form-group ">
                                ...
                                <input type="number"
                                    ...
                                    name="total_cost" value="{{ $item->total_cost }}">
