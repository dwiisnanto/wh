            ...
            <div class="  col-lg-4">
                <div class="card shadow-base bd-0  card__one mg-b-20 rounded-20">
                    <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                        <h6 class="card-title tx-uppercase tx-12 mg-b-0">Create PO for Purhcase Order
                            <br> {{$project->name}}/   {{$purchase_requisition->pr_number}}</h6>
                    </div><!-- card-header -->
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form action="{{url($base_route)}}" method="post">
                                    @csrf
                                    <input type="hidden" autocomplete="off" name="purchase_requisition_id"
                                    value="{{$purchase_requisition->id}}">
                                    @if ($errors->any())
                                    ...
                                    <div class="form-group">
                                        ...
                                        oninput="this.value = this.value.toUpperCase()" value="{{$po_number}}" v-model="po_number"
                                                name="po_number"
                                                class="form-control{{ $errors->has('po_number') ? ' is-invalid' : '' }}" readonly>
                                    ...
                                    <div class="form-group">
                                            ...
                                            {{-- <div>
                                                <input type="text" autocomplete="off"
                                                    oninput="this.value = this.value.toUpperCase()"  value="{{old('vendor')}}"
                                                    name="vendor"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ url($base_route.'/'.$purchase_requisition->id.'/list')}}">
...
<script>
    ...
    //             return this.pr_number + ' - ' + '{{$project->project_number}}'
    //         }
    //     }
    // })
